...
在 twitter 上看到 <fancy-link href='https://cali.so'>cali castle</fancy-link> 大佬直播实现了一个有趣的功能，这个功能的来源是 <fancy-link href='https://uiw.tf/fancy-link-preview'>uiwtf</fancy-link>。
