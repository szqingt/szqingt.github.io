...
> Web Component 是一套不同的技术，允许您创建可重用的定制元素（它们的功能封装在您的代码之外）并且在您的 web 应用中使用它们。 -- <Link href="https://developer.mozilla.org/zh-CN/docs/Web/API/Web_components#%E6%A6%82%E5%BF%B5%E5%92%8C%E4%BD%BF%E7%94%A8">Web Component | MDN</Link>
...
当然目前也存在一些问题
1. 兼容性问题 <Link href="https://caniuse.com/?search=customElements">customElements</Link>
